...
from review.views import add_review_lapangan, delete_review, delete_review_coach, edit_review_coach, get_reviews_json, get_reviews_json_lapangan, get_single_review_json, show_edit_review_lapangan, show_feeds_review_lapangan, show_form_review_coach, show_form_review_lapangan, show_review_lapangan, update_review
...
urlpatterns = [
    ...
    path('review/json/<int:coach_id>/', get_reviews_json, name='get_reviews_json_coach'),
